      ...
      <div className={styles.content}>
        ...
        <section>
          ...
          <p>
            ...
            Internetbased data transmissions may in principle have security
        ...
        <section>
          ...
          <p>
            Website:{' '}
            <a className={styles.anchor} href="https://www.trusted-entity.io/">
              https://www.trusted-entity.io/
            </a>
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The website of the BOTLabs GmbH collects a series of general data
